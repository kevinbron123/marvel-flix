...
async function cargarPersonajes() {
    // Mostrar estado de carga y ocultar el resto
    ...
    try {
        ...
        // Renderizar cada tarjeta de personaje
        personajes.forEach(personaje => {
            ...
            // ...
// Agregar la lógica de clic para la navegación
$col.onclick = () => {
    // Guardar el personaje en localStorage (opcional, por compatibilidad)
    localStorage.setItem("personaje", JSON.stringify(personaje));
    // Ahora también pasamos el id por la URL
